...
public class AddAlarmActivity extends AppCompatActivity {
    ...
    private void addEvents() {
        ...
        txtAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                alarm.setName(name);
                alarm.setSound(R.raw.con_co_be_be);
                ...
                if (alarm.getRepeat() == 0) {
                    if (calendar.getTime().getHours() > alarm.getH()) {
                        alarm.setDay((calendar.get(Calendar.DAY_OF_WEEK)) + "");
                ...
                Toast.makeText(AddAlarmActivity.this, "Thanh cong", Toast.LENGTH_SHORT).show();
                alarm.setStatus(1);
                MyDatabase.getInstance(AddAlarmActivity.this).add(alarm);
    ...
    private void showPopupDialog() {
        PopupMenu popupMenu = new PopupMenu(AddAlarmActivity.this, txtTemp1);
    ...
    private void showDialogChooseDay() {
        ...
        builder.setTitle("Chọn ngày báo thức");
